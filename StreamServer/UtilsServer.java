...
public class UtilsServer {
    ...
    private static void PBEencryption(String path, String password, String algorithm){
		try
		{
	...
	private static void PBEdecryption(String path, String password, String algorithm){
		try
		{
			PBEKeySpec pbeKeySpec = new PBEKeySpec(password.toCharArray());
			SecretKeyFactory secretKeyFactory = SecretKeyFactory.getInstance(algorithm);
